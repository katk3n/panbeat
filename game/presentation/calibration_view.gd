...
func _build_ui() -> void:
	...
	_stage = Label.new(); _stage.text = "① START   →   ② CUE INPUT   →   ③ ANALYZE   →   ④ APPLY & SAVE"; _stage.add_theme_color_override("font_color", Tokens.color("accent")); _stage.add_theme_font_size_override("font_size", 18); layout.add_child(_stage)
